...
describe "Cron Trigger in general" do
  it "should let tasks running at given time interval run" do
    # every 5 seconds
    a = BackgrounDRb::CronTrigger.new("*/5 * * * * * *")
    time = "Wed Feb 13 20:53:43 -0500 2008"
    t_time = Time.parse(time)
    ...
    t_time = Time.parse("Wed Feb 13 23:17:55 -0500 2008")
    firetime = a.fire_after_time(t_time)
  ...
  it "should return correct firetime for hour intervals" do
    # every 5 hour
    t_time = Time.parse("Wed Feb 13 20:53:43 -0500 2008")
    a = BackgrounDRb::CronTrigger.new("0 0 */5 * * * *")
    firetime = a.fire_after_time(t_time)
  ...
  it "should return firetime based on wday restriction" do
    t_time = Time.parse("Wed Feb 13 20:53:43 -0500 2008")
    ...
    t_time2 = Time.parse("Sun Feb 17 20:53:43 -0500 2008")
  ...
  it "should wrap to next week for wday restirctions" do
    a = BackgrounDRb::CronTrigger.new("0 0 */5 * * 0-1 *")
    t_time = Time.parse("Mon Feb 18 20:53:43 -0500 2008")
    firetime = a.fire_after_time(t_time)
    firetime.hour.should == 0
    firetime.min.should == 0
    firetime.sec.should == 0
  ...
  it "should return firetime based on day restriction" do
    t_time = Time.parse("Wed Feb 13 20:53:43 -0500 2008")
    ...
    t_time = Time.parse("Wed Feb 22 20:53:43 -0500 2008")
    # 21st of every month run every 5 hour
    a = BackgrounDRb::CronTrigger.new("0 0 */5 21 * * *")
    firetime = a.fire_after_time(t_time)
    firetime.hour.should == 1
    firetime.min.should == 0
    firetime.sec.should == 0
    firetime.day.should == 21
  ...
  it "for feb month should take into account day count" do
    t_time = Time.parse("Thu Feb 28 20:53:43 -0500 2008")
    # 30th of every month run every 5 hour
  ...
  it "should take care if number of days is not available in month" do
    t_time = Time.parse("Tue Nov 12 20:53:43 -0500 2007")
    # 31st of every month run every 5 hour
  ...
  it "should take care of periodic variations in day restrictions" do
    t_time = Time.parse("Tue Aug 12 20:53:43 -0500 2007")
  ...
  it "should return firetime based on hour restriction" do
    t_time = Time.parse("Wed Feb 13 20:53:43 -0500 2008")
    a = BackgrounDRb::CronTrigger.new("0 0 */5 * * * *")
    firetime = a.fire_after_time(t_time)
    firetime.hour.should == 0
  ...
  it "should take care of both restrictions" do
  ...
  it "for user reported trigger" do
    # on friday
    t_time = Time.parse("Fri Jan 18 4:53:43 -0500 2008")
    ...
    t_time = Time.parse("Fri Jan 18 9:53:43 -0500 2008")
    a = BackgrounDRb::CronTrigger.new("0 0/5 09-17 * * 1,3,5 *")
    firetime = a.fire_after_time(t_time)
    firetime.hour.should == 9
    firetime.min.should == 55
    ...
    t_time = Time.parse("Sat Jan 19 4:53:43 -0500 2008")
    a = BackgrounDRb::CronTrigger.new("0 0/5 09-17 * * 1,3,5 *")
    firetime = a.fire_after_time(t_time)
    firetime.hour.should == 9
    firetime.min.should == 0
    ...
    t_time = Time.parse("Mon Jan 21 4:53:43 -0500 2008")
    a = BackgrounDRb::CronTrigger.new("0 0/5 09-17 * * 1,3,5 *")
    firetime = a.fire_after_time(t_time)
    firetime.hour.should == 9
    firetime.min.should == 0
    ...
    t_time = Time.parse("Tue Jan 1 4:53:43 -0500 2008")
    a = BackgrounDRb::CronTrigger.new("0 0/5 09-17 * * 1,3,5 *")
    firetime = a.fire_after_time(t_time)
    firetime.hour.should == 9
    firetime.min.should == 0
  ...
  it "should return firetime based on month restriction" do
    t_time = Time.parse("Wed Feb 13 20:53:43 -0500 2008")
    a = BackgrounDRb::CronTrigger.new("0 0 */5 * * * *")
    firetime = a.fire_after_time(t_time)
    firetime.hour.should == 0
  ...
  it "should run for weekdays " do
    ...
    t_time = Time.parse("Fri June 6 20:53:43 -0500 2008")
    a = BackgrounDRb::CronTrigger.new("0 0 2 * * 1-5 *")
    firetime = a.fire_after_time(t_time)
    firetime.hour.should == 2
    firetime.min.should == 0
